...
rule getIntronMotif:
	...
	output:
		gff = temp("mappings/" + "getIntronMotif/{techname}_{capDesign}_{barcodes}.introns.gff"),
		tsv = temp("mappings/" + "getIntronMotif/{techname}_{capDesign}_{barcodes}.transcripts.tsv")
	shell:
		'''
