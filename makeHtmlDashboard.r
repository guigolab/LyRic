...
if(allMatureRnaLengthStats != '/dev/null') {
...
if(allTmergeVsSirvStats != '/dev/null') {
...
if(allCagePolyASupportStats != '/dev/null') {
...
if(allNovelFlLociStats != '/dev/null') {
...
if(allNovelLociQcStats != '/dev/null') {
...
if(allNovelFlLociQcStats != '/dev/null') {
...
if(allNtCoverageStats != '/dev/null') {
